...
class BIP66Test(RPGTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # rpgd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and rpgd produces more specific reject
            # reasons.
