...
# TestNode: A peer we use to send messages to rpgd, and store responses.
...
class CompactBlocksTest(RPGTestFramework):
    ...
    # This test actually causes rpgd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that rpgd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for rpgd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # rpgd will not send blocktxn responses for blocks whose height is
