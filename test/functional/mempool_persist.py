...
By default, rpgd will dump mempool on shutdown and
...
class MempoolPersistTest(RPGTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give rpgd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent rpgd from writing mempool.dat to disk. Verify that `savemempool` fails")
