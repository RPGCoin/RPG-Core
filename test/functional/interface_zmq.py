...
from test_framework.test_framework import RPGTestFramework, SkipTest
...
class ZMQTest (RPGTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that rpg has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("rpgd has not been built with zmq enabled.")
