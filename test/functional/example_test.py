...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the RPGTestFramework
    pass

class ExampleTest(RPGTestFramework):
    # Each functional test is a subclass of the RPGTestFramework class.
    ...
    def custom_method(self):
        ...
        RPGTestFramework class so other tests can use it."""
