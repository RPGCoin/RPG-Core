...
class AssetTest(RPGTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="RPG*", verbose=False, count=2, start=-2)
        ...
        rpg_assets = n0.listassets(asset="RPG*", verbose=False, count=2, start=-2)
        assert_equal(len(rpg_assets), 2)
        assert_equal(rpg_assets[0], "RPG2")
        assert_equal(rpg_assets[1], "RPG3")
        self.sync_all()
