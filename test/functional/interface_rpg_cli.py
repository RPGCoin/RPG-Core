...
class TestRPGCli(RPGTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `rpg-cli getinfo`")
        ...
        self.log.info("Compare responses from `rpg-cli -getinfo` and the RPCs data is retrieved from.")
