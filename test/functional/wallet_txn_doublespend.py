...
class TxnMallTest(RPGTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 RPG:
        ...
        # First: use raw transaction API to send 1240 RPG to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 RPG coin each
        ...
        # Node0's balance should be starting balance, plus 50RPG for another
        ...
        # Node0's total balance should be starting balance, plus 100RPG for 
