...
This document provides guidelines for internationalization of the RPG Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rpg_en.ts` remains unchanged.
