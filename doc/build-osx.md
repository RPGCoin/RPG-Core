...
NOTE: At this time it is highly recommended that developers wishing to compile the RPG Core binaries **DO NOT** upgrade to 
...
Use the following commands to compile a working version of RPG Core on Mojave (assuming that the instructions in the section "Build 
RPG Core" has already been followed).  Uninstall Berkeley-db 4.8.3, install the latest version, and _configure_ with the 
...
1. Clone the rpg source code and cd into `rpg`
...
2.  Build rpg-core:
    ...
    Configure and build the headless rpg binaries as well as the GUI (if Qt is found).
...
RPG Core is now available at `./src/rpgd`

Before running, it's recommended you create an RPC configuration file.

    echo -e "rpcuser=rpgrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/RPG/rpg.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/RPG/rpg.conf"

The first time you run rpgd, it will start downloading the blockchain. This process could take several hours.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/RPG/debug.log

Other commands:
-------

    ./src/rpgd -daemon # Starts the rpg daemon.
    ./src/rpg-cli --help # Outputs a list of command-line options.
    ./src/rpg-cli help # Outputs a list of RPC commands when the daemon is running.

Using Qt Creator as IDE
------------------------
You can use Qt Creator as an IDE, for rpg development.
...
4. Enter "rpg-qt" as project name, enter src/qt as location
