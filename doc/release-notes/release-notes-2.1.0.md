RPG Core version *2.1.0* is now available!!
==============

  <https://github.com/RPGCoin/RPG-Core/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/RPGCoin/RPG-Core/commits/release_2.1.0>
