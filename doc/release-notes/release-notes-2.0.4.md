RPG Core version *2.0.4.0* is now available!!
==============

  <https://github.com/RPGCoin/RPG-Core/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/RPGCoin/RPG-Core/commits/release_2.0.4>
...
- Most importantly - The RPG Community!
- Tron Black
- Jesse Empey
- Jeremy Anderson
- Corbin Fox
