...
#ifndef RPG_QT_RPGGUI_H
#define RPG_QT_RPGGUI_H
...
/**
  RPG GUI main class. This class represents the main window of the RPG UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class RPGGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit RPGGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~RPGGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a rpg wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
