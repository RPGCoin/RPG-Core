...
#include "config/rpg-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatRPGURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + RPGUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatRPGURI(info));
}
