...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<RPGAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_rpg-qt -platform xcb      # Linux
//     src/qt/test/test_rpg-qt -platform windows  # Windows
//     src/qt/test/test_rpg-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = RPGUnits::formatWithUnit(unit, balance, false, RPGUnits::separatorAlways);
    ...
    // Amount input
    RPGAmountField* amountInput = receiveCoinsDialog.findChild<RPGAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: rpg:")) != -1);
