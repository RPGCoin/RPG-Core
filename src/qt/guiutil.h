...
#ifndef RPG_QT_GUIUTIL_H
#define RPG_QT_GUIUTIL_H
...
/** Utility functions used by the RPG Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "rpg:" URI into recipient object, return true on successful parsing
