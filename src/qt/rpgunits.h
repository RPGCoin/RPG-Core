...
#ifndef RPG_QT_RPGUNITS_H
#define RPG_QT_RPGUNITS_H
...
/** RPG unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RPGUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RPGUnits(QObject *parent);

    /** RPG units.
      @note Source: https://en.rpg.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        RPG,
...
typedef RPGUnits::Unit RPGUnit;

#endif // RPG_QT_RPGUNITS_H
