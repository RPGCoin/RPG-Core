...
#ifndef RPG_TEST_SCRIPTNUM10_H
#define RPG_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from RPG Core 0.10.0, for cross-comparison.
 */
public:
