    ...
    BOOST_AUTO_TEST_CASE(netbase_splithost_test)
{
    ...
    BOOST_CHECK(TestSplitHost("www.rpg.org", "www.rpg.org", -1));
    BOOST_CHECK(TestSplitHost("[www.rpg.org]", "www.rpg.org", -1));
    BOOST_CHECK(TestSplitHost("www.rpg.org:80", "www.rpg.org", 80));
    BOOST_CHECK(TestSplitHost("[www.rpg.org]:80", "www.rpg.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:7214", "127.0.0.1", 7214));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7214", "127.0.0.1", 7214));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7214", "::ffff:127.0.0.1", 7214));
    BOOST_CHECK(TestSplitHost("[::]:7214", "::", 7214));
    BOOST_CHECK(TestSplitHost("::7214", "::7214", -1));
    BOOST_CHECK(TestSplitHost(":7214", "", 7214));
    BOOST_CHECK(TestSplitHost("[]:7214", "", 7214));
    ...
    BOOST_AUTO_TEST_CASE(netbase_lookupnumeric_test)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:7214", "127.0.0.1:7214"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7214", "[::]:7214"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
