...
BOOST_FIXTURE_TEST_SUITE(asset_reissue_tests, BasicTestingSetup)
    ...
    CNewAsset asset1("RPGASSET", CAmount(100 * COIN), 8, 1, 0, "");

    // Add an asset to a valid rpg address
    ...
    CReissueAsset reissue1("RPGASSET", CAmount(1 * COIN), 8, 1, DecodeIPFS("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));
    ...
    BOOST_CHECK_MESSAGE(asset2.strName == "RPGASSET", "Asset2: Asset name is wrong");
    ...
    undoBlockData.emplace_back(std::make_pair("RPGASSET", CBlockAssetUndo {true, false, "", 0}));
    ...
    CNewAsset asset3;
    BOOST_CHECK_MESSAGE(cache.GetAssetMetaDataIfExists("RPGASSET", asset3), "Failed to get the asset3");
    ...
    BOOST_CHECK_MESSAGE(asset3.strName == "RPGASSET", "Asset3: Asset name is wrong");
    ...
    BOOST_CHECK_MESSAGE(cache.mapReissuedAssetData.count("RPGASSET"), "Map of reissued data was removed, even though changes were made and not databased yet");
    BOOST_CHECK_MESSAGE(cache.mapAssetsAddressAmount.at(make_pair("RPGASSET", Params().GlobalBurnAddress())) == CAmount(100 * COIN), "Assets total wasn't undone when reissuance was");
    }
    ...
    BOOST_AUTO_TEST_CASE(reissue_isvalid_test)
    {
        ...
        CReissueAsset reissue3("RPGASSET", CAmount(1 * COIN), 7, 1, DecodeIPFS("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));
        ...
        CReissueAsset reissue4("RPGASSET", CAmount(1 * COIN), -1, 1, DecodeIPFS("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));

        BOOST_CHECK_MESSAGE(reissue4.IsValid(error, cache), "Reissue4 wasn't valid");

        // Create a new asset object with units of 0
        CNewAsset asset2("RPGASSET2", CAmount(100 * COIN), 0, 1, 0, "");

        // Add new asset to a valid rpg address
        ...
        CReissueAsset reissue5("RPGASSET2", CAmount(1 * COIN), 1, 1, DecodeIPFS("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));
        ...
        CReissueAsset reissue6("RPGASSET2", CAmount(1 * COIN), 1, 1, DecodeIPFS("QmacSRmrkVmvJfbCpmU6pK72furJ8E8fbKHindrLxmYMQo"));
