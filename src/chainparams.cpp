...
{
    const char* pszTimestamp = "Dec 10 2018 Russian Nuclear Bomber Fly to Venezuela";
    const CScript genesisOutputScript = CScript() << ParseHex("04f1972b487cd6ba468bc50e86b3423da115de4d9c1355de27899e98d6b01f4dfefcdbde0fb2acbd7148bd3097bbd4e9f82b0e4003c8b7616bb6416af9ced306c9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ASSETS].nStartTime = 1549210210; // Oct 31, 2018
        ...
        genesis = CreateGenesisBlock(1544560997, 40180939, 0x1e00ffff, 2, 50 * COIN);
		
        consensus.hashGenesisBlock = genesis.GetHash();
                     
        //Main MerkleRoot and GenesisBlock 
        assert(consensus.hashGenesisBlock == uint256S("000000dea116580241cbab013d573f53c267bdd691c08a87b74468e9fb6703ac"));
        assert(genesis.hashMerkleRoot == uint256S("aaab8b2736588348f5111a2e48ca6efe392c32f1761824f108a025af00bb6946"));

        vSeeds.emplace_back("ec2-18-188-230-37.us-east-2.compute.amazonaws.com", false);
		vSeeds.emplace_back("dns1.rpgcoin.gg", false);
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the RPG chain
        ...
        // Burn Addresses
        strIssueAssetBurnAddress = "RXissueAssetxxxxxxxxxxxxxxxy3AdkDQ";
        strReissueAssetBurnAddress = "RXreissueAssetxxxxxxxxxxxxxxyHdtdA";
        strIssueSubAssetBurnAddress = "RXissueSubAssetxxxxxxxxxxxxxynEXEA";
        strIssueUniqueAssetBurnAddress = "RXissueUniqueAssetxxxxxxxxxxuNqFtY";

        //Global Burn Address
        strGlobalBurnAddress = "RXBurnxxxxxxxxxxxxxxxxxxxxxxwgpEia";
...
public:
    CTestNetParams() {
        ...
        uint32_t nGenesisTime = 1544628768;
...
//        /////////////////////////////////////////////////////////////////
        ...
        genesis = CreateGenesisBlock(nGenesisTime, 5266899, 0x1e00ffff, 2, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        
        //Test MerkleRoot and GenesisBlock
        assert(consensus.hashGenesisBlock == uint256S("0000006d3259de07d5267a8bdfea602f155af7b6bd03ddff6ad6b4881e191daf"));
        assert(genesis.hashMerkleRoot == uint256S("aaab8b2736588348f5111a2e48ca6efe392c32f1761824f108a025af00bb6946"));

        vFixedSeeds.clear();
        vSeeds.clear();

        vSeeds.emplace_back("dns2.rpgcoin.gg", false);
        ...
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x96};
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the RPG chain
            1544560997, // * UNIX timestamp of last known number of transactions
...
//        /////////////////////////////////////////////////////////////////
        ...
        genesis = CreateGenesisBlock(1544560997, 1, 0x207fffff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
